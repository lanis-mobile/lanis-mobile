...
try {
    ...
    var client = new SPHclient();

    document.getElementById("login.button").addEventListener("click", async () => {
        client = new SPHclient(
            document.getElementById("login.username").value,
            document.getElementById("login.pass").value,
            Number(document.getElementById("login.schoolid").value)
        );
        document.getElementById("connectionInformation").innerText = "trying to log in...";
        try {
            await client.authenticate();
            document.getElementById("connectionInformation").innerText = "authenticated!"
        } catch (err) {
            console.log(err)
            document.getElementById("connectionInformation").innerText = "login failed"
        }
    })
} catch (err) {
    console.log(err)
