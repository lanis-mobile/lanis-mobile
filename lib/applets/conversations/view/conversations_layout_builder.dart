...
class ConversationsLayoutBuilder extends StatelessWidget {
  ...
  const ConversationsLayoutBuilder({super.key, required this.leftBuilder, this.rightBuilder, required this.rightPlaceholder, required this.onPopRight});
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final int widthParts = constraints.maxWidth ~/ 350 == 0 ? 1 : constraints.maxWidth ~/ 350;
          ...
          return Row(
            children: [
              ...
              Expanded(
                ...
                child: rightBuilder != null ? rightBuilder!(context, isTablet) : rightPlaceholder,
                ),
            ],
          );
        } else {
